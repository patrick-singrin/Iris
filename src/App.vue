...
const navItems: { view: AppView; labelKey: 'nav.events' | 'nav.uiTextGenerator' | 'nav.designPrinciples' | 'nav.settings' }[] = [
    ...
    >
      ...
      >
        <scale-telekom-nav-item
          ...
          :key="item.view"
          :active="activeView === item.view || (item.view === 'documentation' && (activeView === 'event-detail' || activeView === 'event-story'))"
        >
